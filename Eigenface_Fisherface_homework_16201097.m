load facedata % Loading the data source (1)
...
%% Plotting PCA component as per significance and energy (3)
figure(1); 
...
%% top 16 feature selected & shown feature distances between 200 images (5)
kd=16; nface=200;
...
%% Plotting of image point in 3D feature space Eigenface separation in feature space (8 & 9)
...
%% End of Eigenface implementation (10)%%
%%%%%%%%%%%%%%%%%%%%%%%%%
%%
